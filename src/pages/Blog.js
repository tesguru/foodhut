                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="card bg-transparent border my-3 my-md-0">
                            ...
                            <div className="card-body">
                                <h1 className="text-center mb-4"><a href="#" class="badge badge-primary">$5</a></h1>
                    ...
                    <div className="col-md-4">
                        <div className="card bg-transparent border my-3 my-md-0">
                            ...
                            <div className="card-body">
                                <h1 className="text-center mb-4"><a href="#" class="badge badge-primary">$12</a></h1>
                    ...
                    <div className="col-md-4">
                        <div className="card bg-transparent border my-3 my-md-0">
                            ...
                            <div className="card-body">
                                <h1 className="text-center mb-4"><a href="#" class="badge badge-primary">$8</a></h1>
                ...
                <div className="row">
                    <div className="col-md-4 my-3 my-md-0">
                        <div className="card bg-transparent border">
                            ...
                            <div className="card-body">
                                <h1 className="text-center mb-4"><a href="#" class="badge badge-primary">$15</a></h1>
                    ...
                    <div className="col-md-4 my-3 my-md-0">
                        <div className="card bg-transparent border">
                            ...
                            <div className="card-body">
                                <h1 className="text-center mb-4"><a href="#" class="badge badge-primary">$29</a></h1>
                    ...
                    <div className="col-md-4 my-3 my-md-0">
                        <div className="card bg-transparent border">
                            ...
                            <div className="card-body">
                                <h1 className="text-center mb-4"><a href="#" class="badge badge-primary">$3</a></h1>
